...
<head>
<meta charset="utf-8">
<title>Khách hàng đã thanh toán</title>
...
<body id="body-pd">
          ...
          <div class="l-navbar" id="nav-bar">
              <nav class="nav">
                  <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Admin</span> </a>
                      <div class="nav_list">
                        <a href="AdminXacNhanController" class="nav_link">
                      ...
                      <a href="AdminKHTTController" class="nav_link active">
          ...
          <div class="height-100 bg-light">
              <h4><i class="fa-solid fa-list"></i> Khách hàng đã thanh toán</h4>
            
<c:forEach var="item" items="${dathanhtoan}" varStatus="status">
    <c:choose>
        <c:when test="${status.index == 0||dathanhtoan[status.index].makh != dathanhtoan[status.index - 1].makh}">
            <thead>
                <tr>
